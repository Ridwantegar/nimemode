    ...
    if (message.author.id != "840025174651830333")
      return message.channel.send({
        embeds: [new MessageEmbed()
          ...
          .setTitle("Only Truchorko is allowed to deploy the SLASH-COMMANDS")
          .setDescription(`Go to the [Discord-Server](https://discord.gg/utmuExHwyT), open a Ticket and ask for it!`)
        ]
      });
    try {
