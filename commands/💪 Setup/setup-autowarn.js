    ...
    try {
      ...
      async function first_layer(){
        ...
        collector.on("collect", async b => {
          ...
          b?.reply(`<a:923087477680537630:1136849931898986547> **\`Enabled ${enabled} Auto-Warn-Rules\` and \`Disabled ${disabled} Auto-Warn-Rules\` out of \`${b?.values.length} selected Auto-Warn-Rules\`**`)
        })
